    ...
    return (
        <div className="my-11 p-7 flex items-center flex-col md:flex-row justify-between border border-white border-opacity-20 rounded-3xl shadow-xl ">
            <div className="md:pl-8 text-center md:text-left md:mr-2">
                <h1 className="text-base sm:text-xl font-bold uppercase text-[#e9c941]" >Initial Coin Offering</h1>
                <h1 className="text-2xl sm:text-4xl font-bold uppercase text-white" >SAPIEN SQUAD TOKEN</h1>
                <button className='mt-5 px-6 py-2 bg-[#e9c941] text-black rounded font-bold hover:bg-yellow-300' onClick={() => addToken()}>Add Token to your MetaMask</button>
                {/* <div className='mt-3 hidden md:block'>
                <p className="text-lg">For Progress, Investment & Success</p>
            </div> */}
                <div className='mt-10 text-left'>
                    <h3 className=' uppercase text-sm font-semibold mb-2 text-[#e9c941]'>Instructions:</h3>
            ...
            <div className="my-10 border p-10 rounded-xl border-white border-opacity-30  ">
                <form onSubmit={buyToken}>
                    <div className="my-3">
                        <label className="text-base font-bold text-[#e9c941]">Amount BNB</label>
                    ...
                    <div className="my-3">
                        <label className="text-base font-bold text-[#e9c941]">Rate</label>
                        <input className="w-full h-12 rounded-lg p-2 text-xl focus:outline-none mt-1" type="text" value="$0.01" disabled />
                    </div>

                    <div className="mt-10">
                        <button disabled={loading} className="w-full py-2 px-6 uppercase bg-[#e9c941] hover:bg-yellow-300 rounded  font-bold text-black">{loading ? 'Busy' : 'Buy'}</button>
